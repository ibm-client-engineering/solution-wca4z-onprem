---
title: Understand
description: How to create an AD project and Analyze it
sidebar_position: 1
...
This section describes how to create an AD project and analyze it.
...
2. Project type: **Mainframe main languages** -> **Next**
3. Enter Project Name
4. Select Project DB Type (*Microsoft SQL Server*)
5. Select your SQL Server Installation
6. Click **Next** -> **Finish**
7. After the project is successfully created, you need to add some source code files. For this check, the source code is mostly irrelevant as long as 
